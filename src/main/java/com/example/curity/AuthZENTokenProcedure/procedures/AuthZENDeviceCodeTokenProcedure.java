...
public final class AuthZENDeviceCodeTokenProcedure implements DeviceCodeTokenProcedure
{
    ...
    public AuthZENDeviceCodeTokenProcedure(AuthZENTokenProcedureConfig configuration)
    {
