...
public final class AuthZENIntrospectionTokenProcedure implements IntrospectionTokenProcedure
{
    private final AuthZENTokenProcedureConfig _configuration;

    public AuthZENIntrospectionTokenProcedure(AuthZENTokenProcedureConfig configuration)
    {
